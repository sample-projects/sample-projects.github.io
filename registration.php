<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO students VALUES ('$studentId', '$studentName', '$gender', 'null', '$section', '$date')";
    ...
    <div class="container">
        ...
        <form class="content" method="POST" action="#">
            <div class="studentId input-group">
                ...
                <input type="text" name="studentId" id="studentId" required value="<?php echo $studentId ?>">
            </div>
            <div class="name input-group">
                <label for="name">Name</label>
                <input type="text" name="name" id="name" required value="<?php echo $studentName ?>">
            </div>
            <div class="gender input-group">
                <label for="gender">Gender</label>
                <input type="radio" name="gender" id="gender" value="male" value="<?php echo $gender ?>" required>
